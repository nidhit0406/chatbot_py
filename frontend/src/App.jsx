  ...
  return (
    <div className="fixed bottom-5 right-5 z-[9999] flex flex-col items-end">
      ...
      {!isChatOpen && (
        <button
          onClick={toggleChat}
          className="bg-purple-500 hover:bg-purple-600 text-white p-4 rounded-full shadow-lg transition-colors duration-200"
        >
          <SiWechat className="text-2xl" />
        </button>
      )}
      ...
      {isChatOpen && (
        <div className="w-[90vw] max-w-md flex flex-col items-end">
          <Chatbox />
          <button
            onClick={toggleChat}
            className="mt-2 bg-red-500 hover:bg-red-600 text-white p-2 rounded-full shadow-lg transition-colors duration-200"
